...
export const ADMIN_PASSWORD_RESET_TOKEN_TTL_MS = 10 * 60 * 1000;

export const ADMIN_PASSWORD_RESET_TOKEN_TTL_SECONDS = ADMIN_PASSWORD_RESET_TOKEN_TTL_MS / 1000;

export const ADMIN_PASSWORD_RESET_TOKEN_MAX_LENGTH = 128;
